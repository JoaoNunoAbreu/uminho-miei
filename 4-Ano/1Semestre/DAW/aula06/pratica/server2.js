...
function geraPagAlunos( alunos, d){
  ...
  alunos.forEach(a => {
      pagHTML += `
        <tr>
            <td><a href="/alunos/${a.id}">${a.nome}</td>
            <td>${a.id}</td>
            <td>${a.curso}</td>
        </tr>
      `
        ...
        <div class="w3-card-4">
            ...
            <div class="w3-container">
                <ul class="w3-ul w3-card-4" style="width:50%">
                    ...
                    <li><b>Git (link): </b> <a href="https://${aluno.git}">${aluno.git}</a></li>
                </ul>
            </div>
        ...
        switch(req.method){
            case "GET": 
                ...
                // GET /alunos/:id --------------------------------------------------------------------
                    ...
                    .catch(function(erro){
                        res.writeHead(200, {'Content-Type': 'text/html;charset=utf-8'})
                        res.write("<p>Não foi possível obter este aluno...")
                        res.end()
                    })
                }
                // GET /alunos/registo --------------------------------------------------------------------
