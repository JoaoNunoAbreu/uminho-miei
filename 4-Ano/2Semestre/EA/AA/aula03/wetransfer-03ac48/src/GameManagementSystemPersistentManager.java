...
public class GameManagementSystemPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "GameManagementSystem";
	...
	private GameManagementSystemPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new GameManagementSystemPersistentManager();
		}
