...
public class PlatformDAO {
	public static Platform loadPlatformByORMID(int ID) throws PersistentException {
		try {
			PersistentSession session = GameManagementSystemPersistentManager.instance().getSession();
	...
	public static boolean save(Platform platform) throws PersistentException {
		try {
			GameManagementSystemPersistentManager.instance().saveObject(platform);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(Platform platform) throws PersistentException {
		try {
			GameManagementSystemPersistentManager.instance().deleteObject(platform);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(Platform platform) throws PersistentException {
		try {
			GameManagementSystemPersistentManager.instance().getSession().refresh(platform);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(Platform platform) throws PersistentException {
		try {
			GameManagementSystemPersistentManager.instance().getSession().evict(platform);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
