...
public class GameDAO {
	...
	public static boolean save(Game game) throws PersistentException {
		try {
			GameManagementSystemPersistentManager.instance().saveObject(game);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(Game game) throws PersistentException {
		try {
			GameManagementSystemPersistentManager.instance().deleteObject(game);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(Game game) throws PersistentException {
		try {
			GameManagementSystemPersistentManager.instance().getSession().refresh(game);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(Game game) throws PersistentException {
		try {
			GameManagementSystemPersistentManager.instance().getSession().evict(game);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
