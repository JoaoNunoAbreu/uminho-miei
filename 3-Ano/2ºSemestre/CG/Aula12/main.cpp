...
void processMouseButtons(int button, int state, int xx, int yy) 
{
	...
	if (state == GLUT_DOWN)  {
		...
		if (button == GLUT_LEFT_BUTTON)
            ...
            if (picked){
                sprintf(pickingText, "Picked Snowman number %d\n", picked);
				printf("Picked Snowman number %d\n", picked);
            }
            else{
                sprintf(pickingText, "Nothing selected\n");
...
// registo da funÁıes do teclado e rato
